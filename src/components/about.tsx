    ...
    render() {
        ...
        return (
          ...
          <div className="button-container">
            <button className="btn">Affordable Housing</button>
            <button className="btn">Financial Education</button>
            <button className="btn">Job Training</button>
          </div>
          <div className="bg-white">
            <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
             ...
             {this.state.resources.map((props: any) => (
